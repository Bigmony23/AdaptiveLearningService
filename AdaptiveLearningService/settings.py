"""
Django settings for AdaptiveLearningService project.
...
ROOT_URLCONF = 'AdaptiveLearningService.urls'
...
WSGI_APPLICATION = 'AdaptiveLearningService.wsgi.application'
...
# Если Cloudinary не настроен — используем локальное хранилище
if CLOUDINARY_CLOUD_NAME:
    ...
    # Локальная разработка — обычные медиафайлы
    STORAGES = {
        "default": {
